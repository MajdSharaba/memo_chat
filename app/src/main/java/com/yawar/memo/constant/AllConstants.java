...
public interface AllConstants {
    ...
    String ip="13";
//    public String base_url = "http://192.168.1."+ip+":8080/yawar_chat/views/";
     public String base_url = "https://memoback.herokuapp.com/";
//    String delet_from_archived_url = "http://192.168.1."+ip+":3000/deletearchive";
//    String delete_conversation = "http://192.168.1."+ip+":3000/deleteconversation";
...
//    public String upload_Voice_URL = "http://192.168.1."+ip+":3000/uploadAudio";
////    public String upload_Voice_URL = "http://192.168.1."+ip+":3000/uploadAudio";
//    public String upload_file_URL = "http://192.168.1."+ip+":3000/uploadFile";
//    public String upload_video_URL = "http://192.168.1."+ip+":3000/uploadVedio";
//    public String upload_image_URL = "http://192.168.1."+ip+":3000/uploadImgChat";
//    public String get_media = "http://192.168.1."+ip+":3000/getmedia";
...
//        public String load_chat_message =  "http://192.168.1."+ip+":3000/messagesbyusers";
        public String load_chat_message =  "https://memoback.herokuapp.com/messagesbyusers";


//   public  String socket_url = "http://192.168.1."+ip+":3000";

    public  String socket_url = "https://memoback.herokuapp.com";


//    public  String delete_message ="http://192.168.1."+ip+":3000/deletemessage2";
//   public    String add_to_archived_url = "http://192.168.1."+ip+":3000/archivechat";
public  String delete_message =base_url+"deletemessage2";
    public    String add_to_archived_url = base_url+"archivechat";
   public  String get_my_story_url = "http://192.168.1."+ip+":3000/getMyStore";
    public  String delet_my_story_url = "http://192.168.1."+ip+":3000/deleteMyStore";
//    public String add_token = "http://192.168.1."+ip+":3000/addtoken";
