...
class MessageSwipeController(private val context: Context, private val swipeControllerActions: SwipeControllerActions) :
    ...
    override fun getMovementFlags(recyclerView: RecyclerView, viewHolder: RecyclerView.ViewHolder): Int {
        ...
        imageDrawable = context.getDrawable(R.drawable.recentcalls)!!
        shareRound = context.getDrawable(R.drawable.rounded_video_background)!!
    ...
    private fun drawReplyButton(canvas: Canvas) {
        ...
        shareRound.colorFilter =
            PorterDuffColorFilter(ContextCompat.getColor(context, R.color.red), PorterDuff.Mode.MULTIPLY)
